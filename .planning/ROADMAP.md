...
- [x] 04-05-PLAN.md — SkillsSection organism + ContactSection organism with 100% unit test coverage each

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 04-06-PLAN.md — page.tsx wiring + E2E tests + human visual verification
...
- [x] 06-03-PLAN.md — DownloadCVButton atom (next/dynamic SSR-safe wrapper) + 100% unit test coverage
