...
describe("SkillBadge", () => {
  ...
  it("root element is a span", () => {
    const { container } = render(<SkillBadge label="React" domain="frontend" variant="primary" />);
  ...
  it("primary backend has bg-emerald-100 class", () => {
    const { container } = render(<SkillBadge label="Python" domain="backend" variant="primary" />);
    const root = container.firstChild as HTMLElement;
  ...
  it("primary testing has bg-rose-100 class", () => {
    const { container } = render(<SkillBadge label="Jest" domain="testing" variant="primary" />);
    const root = container.firstChild as HTMLElement;
